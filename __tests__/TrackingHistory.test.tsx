...
import { TrackingHistory, GET_TRACKING_EVENTS } from '../app/components/TrackingHistory'
...
it('renders loading indicator and then tracking history', async () => {
  ...
  expect(await screen.findByText("212 Smith Street, Epping 3000 VIC")).toBeTruthy();
...
it("should show error when fetching fails", async () => {
  ...
  expect(await screen.findByText("Could not fetch tracking events")).toBeTruthy();
});
